                            ...
                            <div class="card-body">
                              <div class="mb-1">
                               <label for="" class="form-label h6">Name</label>
                                  ...
                                  form-control form-control-lg" placeholder="Name" 
                                  name="name">
                                  @error('name')
                              ...
                              <div class="mb-1">
                                  ...
                                  form-control form-control-lg" placeholder="Sku" 
                                   name="sku">
                                   @error('sku')
                                     <p class="invalid-feedback">{{$message}}</p>
                                  @enderror
                                ...
                                <div class="mb-1">
                                  ...
                                  form-control form-control-lg" placeholder="Price" 
                                   name="price">
                                   @error('price')
                                     <p class="invalid-feedback">{{$message}}</p>
                                  @enderror
                              ...
                              <div class="mb-1">
                                  <label for="" class="form-label h6">Desciption</label>
                                  <textarea  placeholder="Description"
                                  class="form-control" name="description" cols="30" rows="4">{{old('description',$product->description)}}</textarea>
                               </div>
                              <div class="mb-1">
